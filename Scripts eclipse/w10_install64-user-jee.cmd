...
ECHO Instalación de ECLIPSE 2024-09
ECHO ==============================
ECHO.
...
%UNZIP_DEST%"%PROGRAMDEST%" "%SRCDIR%\eclipse-jee-2024-09-R-win32-x86_64.zip"
ECHO.
...
%UNZIP_DEST%"%JAVADEST%" "%SRCDIR%\windows_10_cmake_Release_Graphviz-12.1.2-win64.zip"
